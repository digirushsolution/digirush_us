        ...
        <div class="topbar-inner">
            <div class="topbar-left topbar-right">
                <ul class="number_box">
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1"
                        ...
                        </svg> <a href="tel:++1 202 539 0556">+1 202 539 0556</a></li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1"
                            x="0px" y="0px" viewBox="0 0 55.2 38.4" style="enable-background:new 0 0 55.2 38.4"
                            xml:space="preserve">
                            <style type="text/css">
                        ...
                        </svg> <a href="tel:++44 1865 60 082">+44 1865 60 082</a></li>
                    <li class="email_icon"><i class="fa-solid fa-envelope "></i>
                        <a href="mailto:contact@digirushsolutions.us">contact@digirushsolutions.us</a>
                    </li>
                </ul>
...
<header class="py-2">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div class="logo">
                <a href="index.html"><img src="image/header_logo.png" alt="" /></a>
            </div>
            <nav class="d-flex flex-grow-1 justify-content-start">
                <ul class="nav">
                    ...
                    <li class="nav-item_2">
                        <a class="nav-link" href="service.php">Services<i class="arrow-down"></i></a>
                    </li>
            ...
            <div class="menu-container-mobile">
                ...
                <nav class="side-menu" id="sideMenu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">Services
                                <i class="fa fa-angle-down" style="font-size: 24px"></i></a>
