...
require('header-nab.php'); 
 ...
 <section class="about_banner_sec" style="background-image: url(image/contact_us_banner.jpg);">
                    ...
                    <div class="col-md-6">
                        <div class="contact-block">
                            <div class="block-inner">
                                <span class="icon"><img src="image/contact-2.png" alt=""></span>
                        ...
                        <div class="contact-block">
                            <div class="block-inner">
                                <span class="icon"><img src="image/contact-3.png" alt=""></span>
